...
def RegistreerMenu():
    ...
    Beschikbare_plaatsen = Label(Scherm_Registratie, text= print_text, font=("Myriad pro cond",30), fg="black", bg="yellow")
    Beschikbare_plaatsen.config(height="1", width="30")
    Beschikbare_plaatsen.place(x="5", y="350")
